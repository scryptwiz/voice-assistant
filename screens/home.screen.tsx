...
export default function HomeScreen () {
  ...
  const sendAudioToWhisper = async (uri: string) => {
    try {
      ...
      console.log("Error transcribing text to GPT-4", error);
    }
  };
          ...
          messages: [
            {
              role: "system",
              content:
                "You are Kelvin's Ai, a friendly AI voice assistant who responds naturally and refer to yourself as Kelvin's Voice Assistant when asked for your name. You are a helpful assistant who can answer questions and help with tasks. You must always respond in the inputted language, no matter the input language,and provide helpful, clear answers",
            },
            {
              role: "user",
              content: text,
